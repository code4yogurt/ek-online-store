...
<div class="col-md-9">
                    <div class="box">
                        <h1>Tumblers</h1>
                        <p>All the tumblers you need to hold your liquids!</p>
                    </div>
...
$query="select count(prod_id) as count from products where status=1 AND subcategory='tumblers'";
...
$query="select * from products where status=1 AND subcategory='tumblers' LIMIT $start,10";
$result=mysqli_query($dbc,$query);
