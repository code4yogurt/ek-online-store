...
<div class="col-md-9">
                    <div class="box">
                        <h1>Hoodies</h1>
                        <p>All the hoodies, jackets, sweaters and coats from Enchanted Kingdom!</p>
                    </div>
...
$query="select count(prod_id) as count from products where status=1 AND subcategory='hoodies'";
...
$query="select * from products where status=1 AND subcategory='hoodies' LIMIT $start,10";
$result=mysqli_query($dbc,$query);
