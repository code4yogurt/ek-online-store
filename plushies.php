...
<div class="col-md-9">
                    <div class="box">
                        <h1>Plushies</h1>
                        <p>All the plushies you need to feel magically comfortable!</p>
                    </div>
...
$query="select count(prod_id) as count from products where status=1 AND subcategory='plushies'";
...
$query="select * from products where status=1 AND subcategory='plushies' LIMIT $start,10";
$result=mysqli_query($dbc,$query);
