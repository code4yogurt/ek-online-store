...
<div class="col-md-9">
                    <div class="box">
                        <h1>Apparel</h1>
                        <p>Everything from shirts, shorts, hoodies, and footwear!</p>
                    </div>
...
$query="select count(prod_id) as count from products where status=1 AND subcategory='apparel'";
...
$query="select * from products where status=1 AND category='apparel' LIMIT $start,10";
$result=mysqli_query($dbc,$query);
