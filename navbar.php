                    ...
                    <div class="modal-body">
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                            <div class="form-group">
                                <input type="text" class="form-control" name="un-modal" maxlength='30' placeholder="Username" value='<?php if(isset($_POST['username'])) echo $_POST['username'] ?>'/>
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" name="pw-modal" maxlength='30' placeholder="Password">
                            </div>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="index.php" data-animate-hover="bounce">
                    ...
                    <img src="img/ek2.png" alt="Obaju logo" class="visible-xs"><span class="sr-only">Obaju - go to homepage</span>
                </a>
