            ...
            <div class="col-md-12" data-animate="fadeInDown">
                <ul class="menu">
                    ...
                    if(isset($_SESSION['type'])){
                     ...
                     echo "<li><a href='login.php' data-toggle='modal' data-target='#login-modal'>Login</a></li>";
                            echo "<li><a href='creation.php'>Register</a></li>";
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="index.php" data-animate-hover="bounce">
                    <img src="http://enchantedkingdom.ph/wp-content/uploads/2014/10/EK-Logo2-mobile.png" alt="EK" height="70" width="250"class="hidden-xs">
                    <img src="http://enchantedkingdom.ph/wp-content/uploads/2014/10/EK-Logo2-mobile.png" alt="EK" height="70" width="250" class="visible-xs"><span class="sr-only">Enchanted Kingdom Home</span>
                </a>
            ...
            <div class="navbar-collapse collapse" id="navigation">
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="dropdown yamm-fw">
                        <a href="apparel.php" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">Apparel <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-lg-2">
                                            <h5><a href="apparel.php">All</a></h5>
                                        </div>
                                        <div class="col-lg-2">
                    ...
                    <li class="dropdown yamm-fw">
                        <a href="drinkware.php" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">DrinkWare <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <h5><a href="drinkware.php">All</a></h5>
                                        </div>
                                        <div class="col-lg-3">
                    ...
                    <li class="dropdown yamm-fw">
                        <a href="toys.php" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">Toys <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <h5><a href="toys.php">All</a></h5>
                                        </div>
                                        <div class="col-lg-3">
                    ...
                    <li class="dropdown yamm-fw">
                        <a href="accessories.php" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">Accessories <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-lg-2">
                                            <h5><a href="accessories.php">All</a></h5>
                                        </div>
                                        <div class="col-lg-2">
                            ...
                            <div class="navbar-buttons">
                                ...
                                <div class="navbar-collapse collapse right" id="basket-overview">
                                    <a href="cart.php" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i></a>
                                </div>
                                <!--/CART COLLAPSE -->
