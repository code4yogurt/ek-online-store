...
<div class="col-md-9">
                    <div class="box">
                        <h1>Pillows</h1>
                        <p>All the pillows you need to sleep magically every night!</p>
                    </div>
...
$query="select count(prod_id) as count from products where status=1 AND subcategory='pillows'";
...
$query="select * from products where status=1 AND subcategory='pillows' LIMIT $start,10";
$result=mysqli_query($dbc,$query);
