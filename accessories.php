...
<div class="col-md-9">
                    <div class="box">
                        <h1>Accessories</h1>
                        <p>Everything from bracelets, pendants, magnets, and keychains!</p>
                    </div>
...
$query="select count(prod_id) as count from products where status=1 AND subcategory='accessories'";
...
$_SESSION['checkout']=0;
$query="select * from products where status=1 AND category='accessories' LIMIT $start,10";
$result=mysqli_query($dbc,$query);
