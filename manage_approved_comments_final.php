...
$pn=1;
              ...
              <div class=" col-lg-12">
                <div class="x_panel">
                  <div class="x_title">
                    <p align='center'><b>List of Approved Comments</p></b>
...
$query="select C.date, P.prod_name, C.username, C.comment, C.comment_id from products P JOIN comments C ON p.prod_id=c.prod_id where c.status = 2 LIMIT $start,10";
$result=mysqli_query($dbc,$query);
