...
$query="select count(prod_id) as count from products where status=1 AND subcategory='drinkware'";
...
$query="select * from products where status=1 AND category='drinkware' LIMIT $start,10";
$result=mysqli_query($dbc,$query);
