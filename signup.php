    ...
    if(empty($_POST['reg-gender'])){
        ...
        //checks if password matches the password verification
            if($pw!=$pwv){
                ...
                $query = "insert into accounts (email, username, password, gender, type)
                values ('{$em}', '{$un}', '{$encpw}', '{$gd}', 'uac')";
                    ...
                    <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="reg-gender" value="M"> M
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="reg-gender" value="F"> F
                            </label>
                        </div> 
