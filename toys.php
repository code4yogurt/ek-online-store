...
<div class="col-md-9">
                    <div class="box">
                        <h1>Toys</h1>
                        <p>Everything from plushies and pillows!</p>
                    </div>
...
$query="select count(prod_id) as count from products where status=1 AND subcategory='toys'";
...
$query="select * from products where status=1 AND category='toys' LIMIT $start,10";
$result=mysqli_query($dbc,$query);
