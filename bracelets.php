...
<div class="col-md-9">
                    <div class="box">
                        <h1>Bracelets</h1>
                        <p>All the bracelets that give that magical feel!</p>
                    </div>
...
$query="select count(prod_id) as count from products where status=1 AND subcategory='bracelets'";
...
$query="select * from products where status=1 AND subcategory='bracelets' LIMIT $start,10";
$result=mysqli_query($dbc,$query);
