...
<div class="col-md-9">
                    <div class="box">
                        <h1>Shirts</h1>
                        <p>All the tops from Enchanted Kingdom!</p>
                    </div>
...
$query="select count(prod_id) as count from products where status=1 AND subcategory='shirts'";
...
$query="select * from products where status=1 AND subcategory='shirts' LIMIT $start,10";
$result=mysqli_query($dbc,$query);
 ...
 <div class="col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    ...
                                    <form action="specificItem_chu.php" method="GET">
                                        <p class="buttons">
