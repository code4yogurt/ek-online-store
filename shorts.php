...
<div class="col-md-9">
                    <div class="box">
                        <h1>Shorts</h1>
                        <p>All the bottoms from Enchanted Kingdom!</p>
                    </div>
...
$query="select count(prod_id) as count from products where status=1 AND subcategory='shorts'";
...
$query="select * from products where status=1 AND subcategory='shorts' LIMIT $start,10";
$result=mysqli_query($dbc,$query);
