...
<br><br><b>LIST OF DISAPPROVED COMMENTS:</b><br><br>
...
$query="select C.date, P.prod_name, C.username, C.comment, C.comment_id from products P JOIN comments C ON p.prod_code=c.prod_id where c.status = 0 LIMIT $start,10";
$result=mysqli_query($dbc,$query);
