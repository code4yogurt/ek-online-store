...
$query="select count(prod_id) as count from products where status=1 AND subcategory='shotglasses'";
...
$query="select * from products where status=1 AND subcategory='shotglasses' LIMIT $start,10";
$result=mysqli_query($dbc,$query);
