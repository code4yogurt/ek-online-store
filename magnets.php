...
<div class="col-md-9">
                    <div class="box">
                        <h1>Magnets</h1>
                        <p>All the magnets that give you that magical power of every wizard!</p>
                    </div>
...
$query="select count(prod_id) as count from products where status=1 AND subcategory='magnets'";
...
$query="select * from products where status=1 AND subcategory='magnets' LIMIT $start,10";
$result=mysqli_query($dbc,$query);
