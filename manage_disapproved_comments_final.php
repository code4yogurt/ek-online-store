...
$pn=1;
              ...
              <div class=" col-lg-12">
                <div class="x_panel">
                  <div class="x_title">
                    <p align='center'><b>List of Disapproved Comments</p></b>
...
$query="select C.date, P.prod_name, C.username, C.comment, C.comment_id from products P JOIN comments C ON p.prod_id=c.prod_id where c.status = 0 LIMIT $start,10 ";
$result=mysqli_query($dbc,$query);
...
<form action='pending_comment.php' method='POST'>
      <button type='submit' name='pending' value='<?php echo "{$row['comment_id']}";?>'>Move to Pending List</button>
      </form>
